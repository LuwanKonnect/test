...
export declare class StripeController {
    ...
    findOne(id: string): Promise<StripeEntity>;
    createCustomer(payload: any): Promise<StripeEntity>;
    createAccount(createAccount: CreateAccountDto, req: any): Promise<import("stripe").Stripe.Response<import("stripe").Stripe.Account>>;
    createCharge(charge: CreateChargeDto, u_id: string): Promise<import("stripe").Stripe.Response<import("stripe").Stripe.PaymentIntent>>;
    oneOffPayment(charge: CreateChargeDto): Promise<import("stripe").Stripe.Response<import("stripe").Stripe.PaymentIntent>>;
    addCreditCard(paymentMethodIdDto: PaymentMethodIdDto, u_id: string): Promise<import("stripe").Stripe.Response<import("stripe").Stripe.SetupIntent>>;
    getCreditCards(u_id: string): Promise<import("stripe").Stripe.Response<import("stripe").Stripe.ApiList<import("stripe").Stripe.PaymentMethod>>>;
    deleteCreditCard(paymentMethodId: string): Promise<import("stripe").Stripe.Response<import("stripe").Stripe.PaymentMethod>>;
    setDefaultCard(paymentMethodIdDto: PaymentMethodIdDto, u_id: string): Promise<void>;
    createMonthlySubscription(u_id: string): Promise<import("stripe").Stripe.Response<import("stripe").Stripe.Subscription>>;
    getMonthlySubscription(u_id: string): Promise<import("@nestjs/common").NotFoundException | import("stripe").Stripe.Subscription>;
    handleIncomingEvents(signature: string, request: RequestWithRawBody): Promise<void>;
    cancelSubscription(u_id: string): Promise<any>;
}
