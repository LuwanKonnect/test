...
const httpRequest_service_1 = require("./httpRequest.service");
...
FeaturesModule = __decorate([
    common_1.Module({
        ...
        providers: [httpRequest_service_1.HttpRequestService],
        exports: [httpRequest_service_1.HttpRequestService],
    })
], FeaturesModule);
